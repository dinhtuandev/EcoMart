    ...
    <div className="space-y-8 pb-16">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-gray-100 pb-4">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                Tổng doanh thu kỳ: {formatCurrency(revenueReport?.totalRevenue || 0)} (
        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-black text-slate-900 tracking-tight flex items-center gap-2">
              ...
              Cơ Cấu Doanh Thu Sinh Thái (Sales Breakdown)
            </h2>
            <p className="text-xs text-slate-500 mt-0.5">
              Phân bổ tỷ trọng doanh số theo danh mục sản phẩm và thương hiệu đối tác
            </p>
          </div>
        </div>
      ...
      <div className="space-y-4 pt-4 border-t border-gray-200/60">
        <div>
          <h2 className="text-lg font-black text-slate-900 tracking-tight flex items-center gap-2">
            ...
            Sức Khỏe Khách Hàng & Nguy Cơ Rời Bỏ (Customer Retention)
          </h2>
          <p className="text-xs text-slate-500 mt-0.5">
            Phân tích tỷ lệ khách hàng mua lại và cảnh báo những khách hàng có nguy cơ rời bỏ nền tảng
          </p>
        </div>
          ...
          <div className="lg:col-span-4 bg-white border border-gray-100 rounded-3xl p-6 shadow-sm space-y-4 flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                Tỷ lệ khách hàng đã hoàn thành từ 2 đơn hàng trở lên trên tổng số khách mua hàng.
              </p>
            </div>
      ...
      <div className="space-y-4 pt-4 border-t border-gray-200/60">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Điểm hài lòng trung bình, phân bổ sao đánh giá và kiểm soát nội dung đánh giá của khách hàng
          </p>
        </div>
            ...
            <div className="flex items-center gap-1 text-amber-200 text-xs pt-3 border-t border-amber-400/40">
              {[1, 2, 3, 4, 5].map((s) => (
                <Star
                  key={s}
                  className={`w-4 h-4 ${
                    s <= Math.round(reviewInsights?.averagePlatformRating || 5)
                      ? 'fill-white text-white'
                      : 'text-amber-300/40'
                  }`}
                />
              ))}
              <span className="ml-1.5 font-bold text-white">Xuất Sắc</span>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm space-y-2 flex flex-col justify-between">
            <div>
              ...
              <div className="text-3xl font-black text-emerald-600 mt-2">
                {reviewInsights?.satisfactionRate
