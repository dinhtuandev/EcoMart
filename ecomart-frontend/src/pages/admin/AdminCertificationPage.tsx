...
import { Certification, CustomAxiosError } from '../../types';

export const AdminCertificationPage: React.FC = () => {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">
              Quản lý các tiêu chuẩn nhãn xanh (FSC, USDA Organic, OEKO-TEX, Fair Trade...)
            </p>
          </div>
        </div>
                ...
                {filteredCertifications.map((cert) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 bg-emerald-100 text-emerald-700 rounded-lg flex items-center justify-center flex-shrink-0 font-bold text-xs">
                          {cert.iconUrl ? (
                            <img
                              src={cert.iconUrl}
                              alt={cert.name}
                    ...
                    <td className="py-4 px-4 text-center">
                      ...
                      >
                        ...
                        />
                        {cert.isActive ? 'Đang áp dụng' : 'Tạm ẩn'}
                      </span>
                    </td>
                    ...
                    <td className="py-4 px-4 text-right">
                      <div className="inline-flex items-center gap-1.5">
                        ...
                        <button
                          ...
                          title={cert.isActive ? 'Nhấn để tạm ẩn' : 'Nhấn để kích hoạt'}
                        >
                          {cert.isActive ? 'Ẩn' : 'Bật'}
                        </button>
                      </div>
                    </td>
                  </tr>
