...
export const AdminProductPage: React.FC = () => {
  ...
  const filteredProducts = useMemo(() => {
    return products.filter((product) => {
      ...
      if (filterStatus === 'OUT_OF_STOCK') return product.quantityInStock <= 0;
      return true;
    });
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">
              Quản lý danh mục hàng hóa xanh, chứng nhận sinh thái và kho hàng
            </p>
          </div>
        </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="max-w-xs">
                            <p className="font-bold text-slate-900 hover:text-emerald-600 transition-colors line-clamp-2">
                              {product.name}
                            </p>
                      ...
                      <td className="py-4 px-4 text-xs">
                        <span className="inline-block px-2 py-0.5 bg-slate-100 text-slate-700 font-semibold rounded-md mb-1">
                      ...
                      <td className="py-4 px-4 text-center">
                        ...
                        >
                          ...
                          />
                          {product.isVisible ? 'Hiển thị' : 'Đang ẩn'}
                        </span>
                      </td>
