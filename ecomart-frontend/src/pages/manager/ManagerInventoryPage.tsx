                  ...
                  <tr key={item.id || item.productId} className="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td className="px-5 py-4 text-right whitespace-nowrap">
                      <button
                        ...
                        className="inline-flex items-center gap-1 px-3 py-1.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 text-xs font-bold rounded-xl border border-emerald-200 transition-colors cursor-pointer"
                      >
